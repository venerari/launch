...
----
$ git clone git@github.com:venerari/launch
...
== More Information
You can learn more about this booster and the Node.js runtime in the link:http://appdev.openshift.io/docs/nodejs-runtime.html[Node.js Runtime Guide].
